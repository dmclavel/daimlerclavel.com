...
const useScrollAnimate = () => {
    useEffect(() => {
        const scrollListener = document.addEventListener('scroll', function (e) {
            ...
            if (scrollTop + clientHeight >= tlBlockRect.top + scrollTop + tlBlockRect.height + extraMargin) {
            ...
            if (scrollTop + clientHeight >= box1Rect.top + scrollTop + box1Rect.height - extraMargin) {
                box1El.classList.add('animate-up-delay-1');
            }

            if (scrollTop + clientHeight >= box2Rect.top + scrollTop + box2Rect.height - extraMargin) {
                box2El.classList.add('animate-up-delay-1');
            }

            if (scrollTop + clientHeight >= box3Rect.top + scrollTop + box3Rect.height - extraMargin) {
                box3El.classList.add('animate-up-delay-1');
            }

            if (scrollTop + clientHeight >= box4Rect.top + scrollTop + box4Rect.height - extraMargin) {
                box4El.classList.add('animate-up-delay-1');
            }

            if (scrollTop + clientHeight >= box5Rect.top + scrollTop + box5Rect.height - extraMargin) {
                box5El.classList.add('animate-up-delay-1');
            }

            if (scrollTop + clientHeight >= box6Rect.top + scrollTop + box6Rect.height - extraMargin) {
                box6El.classList.add('animate-up-delay-1');
            }

            if (scrollTop + clientHeight >= projBox1Rect.top + scrollTop + projBox1Rect.height) {
            ...
            if (scrollTop + clientHeight >= accBlockRect.top + scrollTop + accBlockRect.height) {

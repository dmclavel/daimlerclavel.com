...
const AnimatedBorders = ({ hovered }) => {
    ...
    let leftBorderClass = 'absolute top-0 left-0 transform rotate-90 origin-top-left w-full h-1 bg-blue dark:bg-mint-dark';
    let bottomBorderClass = 'absolute bottom-0 left-0 w-full h-1 bg-blue dark:bg-mint-dark';
    let rightBorderClass = 'absolute bottom-0 right-0 transform -rotate-270 origin-bottom-right w-full h-1 bg-blue dark:bg-mint-dark';
